      ...
      >
        <div className="w-full max-w-md">
          ...
          <div className="card p-6">
            ...
            {claimSearch.length > 1 && filteredOrgs.length === 0 && (
              <p
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        ...
                        style={{ background: getStatusColor(vol.status) }}
                      />
                      <div>
        ...
        {activeTab === "volunteers" && (
          <div>
            ...
            <p
              ...
              style={{ color: "var(--text-secondary)" }}
            >
              Engagement status powered by churn prediction model. Green =
              active, yellow = cooling off, red = at risk of leaving.
            </p>
        ...
        {activeTab === "handoffs" && (
          <div className="animate-fade-in">
            ...
            <p
              ...
              style={{ color: "var(--text-secondary)" }}
            >
              When volunteers leave, their knowledge stays. Handoff documents
              are attached to roles, not people.
            </p>
            ...
            >
              ...
              <button className="btn btn-outline text-sm mt-3">
    ...
    <div className="card mb-3 overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs" style={{ color: "var(--text-muted)" }}>
              {vol.total_hours} hours • {vol.total_shifts} shifts •{" "}
        ...
        <div className="flex items-center gap-3">
          <span
            ...
            style={{
              background: getStatusBg(vol.status),
              color: getStatusColor(vol.status),
            }}
          >
      ...
      {expanded && (
        ...
        >
          <div className="grid grid-cols-2 gap-4 pt-3 text-sm">
            <div>
              ...
              <span className="font-medium">
                {vol.last_active_days_ago} days ago
              </span>
            </div>
            <div>
          ...
          {vol.status !== "active" && (
            <button className="btn btn-primary text-sm mt-3">
              Send Check-in
            </button>
          )}
        </div>
